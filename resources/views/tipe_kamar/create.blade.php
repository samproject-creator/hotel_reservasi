...
<div class="max-w-4xl mx-auto">
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Add Room Type</h1>
            <p class="text-gray-500">Define a new category of rooms.</p>
        </div>
            ...
            <div class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="deskripsi" id="deskripsi" rows="4"
                        class="w-full px-4 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent">{{ old('deskripsi') }}</textarea>
