...
<div class="max-w-4xl mx-auto">
    <div class="mb-6 flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-500">Create a new staff or admin account.</p>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <select name="role" id="role"
                        class="w-full px-4 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent" required>
                        <option value="petugas" {{ old('role') == 'petugas' ? 'selected' : '' }}>Petugas (Staff)</option>
                ...
                <div class="space-y-2">
                    <label for="password_confirmation" class="text-sm font-bold text-gray-700">Confirm Password</label>
